...
//Used if our bot is on the bottom blue side of the arena
...
public class BlueOneAuto447 extends LinearOpMode {
    ...
    //Same thing as red one but inverted?

      //The ground junction:
        drive(10, 10, -10, -10, 1); //turn left ~ 45 degrees
        drive(30, 30, 30, 30, 1);
        drive(-20,-20,-20,-20,1); //drive out of the ground junction to get to next target.
